...
export function SettingsButton({ onClick }) {
  ...
  return (
    <button onClick={(e) => handleClick(e)} className="gear">
      <svg
        width="30"
        height="30"
        viewBox="0 0 35 35"
...
export function SettingsPanel({ toggleAction, values, toggleView }) {
  return (
    <div className="settings">
      <div onClick={(e) => toggleView(e)} className="close-settings">
        <svg
          width="32"
          height="32"
          viewBox="0 0 32 32"
